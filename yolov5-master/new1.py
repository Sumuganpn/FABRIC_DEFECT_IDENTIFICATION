...
def plot_boxes(results, frame,classes):
    ...
    for i in range(n):
        row = cord[i]
        if row[4] >= 0.60: ### threshold value for detection. We are discarding everything below this value
            ...
            img_id =  '{}.jpg'.format(uuid.uuid1())
            
            with open('nw.csv',mode = 'a', newline='') as f:
                csv_writer = csv.writer(f,delimiter= ',',quotechar='"',quoting=csv.QUOTE_MINIMAL)
                csv_writer.writerow([img_id,plate_num])
...
#main(vid_path=1,vid_out="webcam_facemask_result.mp4") #### for webcam

#main(img_path="D:\\yo\\numberplaterecognition-main\\test_images\\Cars118.jpg") ## for image
